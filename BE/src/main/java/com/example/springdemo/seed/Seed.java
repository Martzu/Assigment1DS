...
public class Seed implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        /*HospitalUser doctor1 = new HospitalUser("Alex", "M", "Cluj", "Alex", "parola", HospitalUserRoles.MEDIC);

        HospitalUser patient1 = new HospitalUser("Andrei", "M", "Cluj", "Andrei", "parola", HospitalUserRoles.PATIENT);
        HospitalUser patient2 = new HospitalUser( "Andreea", "F", "Cluj", "Andreea", "parola", HospitalUserRoles.PATIENT);
        HospitalUser patient3 = new HospitalUser( "Ioana", "F", "Cluj", "Ioana", "parola", HospitalUserRoles.PATIENT);
        ...
        HospitalUser careTaker1 = new HospitalUser("Mihaela", "F", "Cluj", "Mihaela", "parola", HospitalUserRoles.CARETAKER, patients);
        ...
        HospitalUser patient4 = new HospitalUser( "Ion", "M", "Suceava", "Ion", "parola", HospitalUserRoles.PATIENT);
