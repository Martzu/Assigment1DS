...
export default function SimpleModal() {
    ...
    const addPatient = () => {
        axios.post("http://localhost:8080/patient",
            {sessionId: localStorage.getItem("sessionId"), role: "patient",name: newPatient.name, address: newPatient.address, gender: newPatient.gender, birthDate: newPatient.birthDate}).then(response => {
